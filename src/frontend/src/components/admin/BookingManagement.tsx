...
import { Calendar, User, Phone, MapPin, DollarSign, Clock } from 'lucide-react';
...
export default function BookingManagement() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-100">Booking Management</h2>
        <p className="text-sm text-slate-400 mt-1">View and manage all customer bookings with complete details</p>
      </div>
