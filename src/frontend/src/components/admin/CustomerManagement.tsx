...
import {
  copyCustomerCSVToClipboard,
  downloadCustomerCSV,
} from "../../lib/customerCsvExport";
import {
  type Customer,
  deleteCustomer,
  getAllCustomers,
...
export default function CustomerManagement() {
  ...
  const [deleteConfirmCustomer, setDeleteConfirmCustomer] =
  ...
  return (
    <div className="space-y-6 animate-fade-in">
        ...
        <DialogContent className="glass-card border-slate-800 shadow-saffron-lg">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="editName" className="text-slate-300">
                Name
              </Label>
              <Input
                id="editName"
            ...
            <div className="space-y-2">
              <Label htmlFor="editPhone" className="text-slate-300">
                Phone
              </Label>
              <Input
                id="editPhone"
      ...
      <Dialog
        ...
        onOpenChange={() => setDeleteConfirmCustomer(null)}
      >
        <DialogContent className="glass-card border-slate-800 shadow-saffron-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-400 text-center">
              ...
              <strong>{deleteConfirmCustomer?.name}</strong>? This action cannot
              be undone.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showSheetsConfig} onOpenChange={setShowSheetsConfig}>
        <DialogContent className="glass-card border-slate-800 shadow-saffron-lg">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="sheetsUrl" className="text-slate-300">
                Google Sheets URL
              </Label>
              <Input
                id="sheetsUrl"
