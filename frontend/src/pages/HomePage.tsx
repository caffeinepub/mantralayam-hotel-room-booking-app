...
import { Calendar, CreditCard, Shield, MapPin, Building2, Hotel, Search, Sparkles, ChevronLeft, ChevronRight, Clock, AlertTriangle } from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground text-lg">
                If you encounter any issues or have concerns, please let us know. We're here to help!
              </p>
            </div>
            <ReportIssueDialog 
              trigger={
