...
export default function PartnerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const success = await actor.authenticatePartnerWithPassword(password.trim());
      ...
      if (success) {
        ...
        if (!partnerId) {
          setError('Authentication succeeded but partner ID could not be retrieved. Please try again.');
          setIsLoading(false);
          return;
        }
        ...
        await queryClient.invalidateQueries({ queryKey: ['authenticatedPartnerId'] });
